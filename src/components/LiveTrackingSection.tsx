...
export default function LiveTrackingSection() {
  ...
  useEffect(() => {
    ...
    // Create a custom neon bus marker element matching the premium teardrop pinpoint pointer design
    ...
    el.style.borderRadius = "50% 0 50% 50%"; // Premium teardrop pinpoint shape pointing Northeast (45 degrees)!
